...
class ProfileSearchService {
  ...
  Future<Map<String, dynamic>> checkUsernameAvailability({
    ...
    print(
        'ProfileSearchService: Checking availability for Username: $username');

    final response =
        await client.get(ApiEndpoints.checkusernameAvailability(username));
    ...
    throw Exception("Unexpected username availability response: $body");
  }
}
