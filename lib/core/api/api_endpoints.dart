...
static String updateClub(String clubId) =>
    "$baseUrl/club/$clubId";

/// 3️⃣ Delete Club (DELETE /club/:clubId) [JWT]
static String deleteClub(String clubId) =>
    "$baseUrl/club/$clubId";
...
static String getClubStats(String clubId) =>
    "$baseUrl/club/$clubId/stats";
...
static String updateStory(String topicId) =>
    "$baseUrl/story/$topicId";

/// 5️⃣ Patch Story (PATCH /story/:topicId) [JWT]
static String patchStory(String topicId) =>
    "$baseUrl/story/$topicId";

/// 6️⃣ Delete Story (DELETE /story/:topicId) [JWT]
static String deleteStory(String topicId) =>
    "$baseUrl/story/$topicId";
